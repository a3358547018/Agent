...
def run_daily_job():
    ...
    # ── 并行抓取 ───────────────────────
    print("  → 启动并行抓取任务…")
    # Using ThreadPoolExecutor to run independent network-bound tasks concurrently.
    # This reduces overall execution time significantly by overlapping network latencies.
